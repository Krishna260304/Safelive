...
from app.services.pincode_service import warmup_pincode_index
...
app.add_middleware(
	...
	allow_origin_regex=r"^https?://(localhost|127\.0\.0\.1|192\.168\.\d+\.\d+|10\.\d+\.\d+\.\d+|.*\.safelive\.in|.*\.trycloudflare\.com)(:\d+)?$",
